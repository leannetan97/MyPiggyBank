...
class AddTransactionState extends State<AddTransaction> {
  bool transactionIconIsPressed = false;

  static String _dropdownTransactionType = '${StringsUtil.expensesLabel}';
  static List<CategoryItem> _categoryExpensesList = [
...
//    new CategoryItem((Icons.business_center.codePoint).toString(), 'Office / Work')
  ...
  static List<CategoryItem> _categoryIncomeList = [
  ...
  CategoryItem _iconForTransactionSelected =
      (_dropdownTransactionType == '${StringsUtil.expensesLabel}')
          ? _categoryExpensesList[0]
          : _categoryIncomeList[0];
  ...
  Widget _pageTitle() {
    return Container(
      child: Row(
        children: <Widget>[
          Text('${StringsUtil.newTransactionTitle}'),
          Padding(
            padding:
    ...
    return Container(
        ...
        child: Column(children: <Widget>[
          CircleAvatar(
            ...
            backgroundColor: (_iconForTransactionSelected == c)
                ? ColorsUtil.secondaryColor
  ...
  _iconSelected(CategoryItem c) {
    setState(() {
      _iconForTransactionSelected = c;
    });
    _navigateToAddTransactionDetails();
  }

  void _navigateToAddTransactionDetails() {
    Navigator.of(context).push(MaterialPageRoute<void>(
        settings:
            RouteSettings(name: '${StringsUtil.addTransactionDetailsPage}'),
        builder: (context) => AddTransactionDetails(_iconForTransactionSelected)));
  }
}
